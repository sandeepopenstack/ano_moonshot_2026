...
def generate_gnn_inference_event(scenario: str = None) -> dict:
    ...
    if scenario == "UC3_TRANSPORT_REMEDIATION":
        ...
        "businessPriority": "CRITICAL",
        "anomalyScore": {"zScore": 8.2, "confidence": 0.94},
        "anomalousSubgraph": {
            "nodes": ["TRANSPORT_LINK_01", "AGG_NODE_01"],
            "edges": [("TRANSPORT_LINK_01", "AGG_NODE_01")],
        },
        "rankedRemediationBranches": [
            {"action_id": "A", "domain": "TRANSPORT", "priority_score": 10,
            "recommended_fix": "FAILOVER_TO_REDUNDANT_PATH"},
        ],
        "routingHint": {"targetAgent": "MonitoringAgent", "priorityOrder": "A"},
    }
